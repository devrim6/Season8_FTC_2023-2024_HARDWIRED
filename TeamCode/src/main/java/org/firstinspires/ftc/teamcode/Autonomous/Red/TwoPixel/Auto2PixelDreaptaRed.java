...
@Autonomous(group = "Auto Red", name = "Auto2PixelDreaptaRed")
public class Auto2PixelDreaptaRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action TRAJ3_ParkL = drive.actionBuilder(leftBackboardPose)
                .setReversed(false)
            ...
            switch (currentTraj){
                ...
                case TRAJ2_LineToBackboard:
                    if(!auto.isTrajGoing) {
                        ...
                        switch (elementPosition){
                            case "left":
                                Actions.runBlocking(auto.followTrajectoryAndStop(TRAJ3_ParkL));
                                break;
                            case "right":
                                Actions.runBlocking(auto.followTrajectoryAndStop(TRAJ3_ParkR));
                                break;
                            default:
                                Actions.runBlocking(auto.followTrajectoryAndStop(TRAJ3_ParkM));
                                break;
                        }
                    }
                    break;
